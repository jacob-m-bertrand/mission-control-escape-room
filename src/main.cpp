...
String buildDcdPage() {
  String page = F(
      ...
      ".panel{max-width:720px;margin:auto;background:rgba(15,23,42,.85);padding:2rem;"
      ...
      "</style></head><body><div class='panel'><h1>Mission Control</h1>"
      "<div id='dcd-content'>");
...
String buildControlPanelPage() {
  String page = F(
      ...
      "<style>"
      "body{font-family:'Segoe UI',sans-serif;background:#0f172a;color:#e2e8f0;margin:0;padding:1rem;}"
      ...
      "</style></head><body><h1>GM Control Panel</h1>"
  ...
  page += F("</div>"
        ...
        "</script>"
        "<p><a href='/'>View DCD display</a></p></body></html>");
  return page;
}
